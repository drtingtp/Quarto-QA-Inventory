...
-   Storing all documentation of QA project on Powerpoint slides

-   Storing data tables only on Power point slides

-   Hiding slides, e.g. literature review too lengthy
...
::: fragment
Due to the problems above, difficult to curate or retrieve information about the project
:::

# Recommendation 1: Google Docs
